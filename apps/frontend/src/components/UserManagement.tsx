// apps/frontend/src/components/UserManagement.tsx
    ...
    <div className="space-y-6">
      ...
      <ChartCard title="All Users">
        <div className="flex flex-wrap items-center gap-3 mb-4">
          <div className="flex-1 min-w-[200px] flex items-center gap-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-xs border-b border-gray-100 dark:border-gray-800">
                  ...
                  <th className="font-semibold py-3 px-2 text-gray-900 dark:text-white w-10">
                    Action
                  </th>
                </tr>
              </thead>
                  ...
                  >
                    <td className="py-3 px-2">
                      <div className="flex items-center gap-2">
                        <AvatarInitial name={u.name} email={u.email} />
                        <div>
                    ...
                    <td className="py-3 px-2 text-gray-500 dark:text-gray-400 text-xs hidden md:table-cell whitespace-nowrap">
                    ...
                    <td className="py-3 px-2">
                      {u.id === user.id ? null : deleteConfirm === u.id ? (
                        <div className="flex items-center gap-1 animate-slideDown whitespace-nowrap">
                          <button
